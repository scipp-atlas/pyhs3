...
This guide shows how to create custom Functions and Distributions for use with pyhs3. These custom components should follow the :external+hs3:ref:`HS3 specification <hs3.sec:distributions>` for distributions and :external+hs3:ref:`functions <hs3.sec:functions>`.
